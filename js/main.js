...
emailjs.init('uw16Zbxa-pYq1K1WB');
...
form.addEventListener('submit', function (event) {
  ...
  const subject = document.querySelector('input[placeholder="Subject of the message"]').value.trim();
  ...
  if (!isValid) {
    ...
    emailjs.send('service_zpgymxj', 'template_omf7j3r', templateParams)
